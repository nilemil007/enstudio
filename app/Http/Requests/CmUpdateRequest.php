...
class CmUpdateRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'type'                  => ['nullable'],
            'pool_number'           => ['required','digits: 11','unique:cms,pool_number,'.request()->segment(2)],
            'personal_number'       => ['nullable','digits: 11','unique:cms,personal_number,'.request()->segment(2)],
            'nid_number'            => ['nullable',new Nid,'unique:cms,nid_number,'.request()->segment(2)],
