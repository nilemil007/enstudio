                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-9">
                        <select name="house_code" class="form-select @error('house_code') is-invalid @enderror" id="house_code">
                            ...
                            <option @selected($retailer->house_code == 'rso') value="rso">RS0</option>
                            <option @selected($retailer->house_code == 'bp') value="bp">BP</option>
                            <option @selected($retailer->house_code == 'tmo') value="tmo">TMO</option>
                        </select>
                    </div>
                </div>
