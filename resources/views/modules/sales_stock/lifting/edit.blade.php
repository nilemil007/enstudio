<x-app-layout>
    ...
    <!-- Title -->
    <x-slot:title>Update Lifting</x-slot:title>

    <div class="row">
        <div class="col-md-12">
            <form x-data="liftingCreate" id="cmForm" action="{{ route('lifting.update', $lifting->id) }}" method="POST">
            ...
            @method('PATCH')
                ...
                <div class="card mb-3 bg-secondary bg-gradient">
                    <div class="card-header">
                        <h3 class="m-0 text-white">Update Lifting</h3>
                    </div>
                    <div class="card-body">
                        <!-- Lifting Date -->
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <div class="input-group">
                                    <input name="lifting_date" id="lifting_date" type="text" value="{{ $lifting->lifting_date }}" class="flatpickr form-control" placeholder="Select date">
                                ...
                                <select name="dd_house_id" class="form-select" id="dd_house_id" >
                                    ...
                                    @if(count($houses) > 0)
                                        @foreach($houses as $house)
                                            <option @selected($lifting->dd_house_id == $house->id) value="{{ $house->id }}">{{ $house->code .' - '. $house->name }}</option>
                                        @endforeach
                                    @endif
                                </select>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3 mb-3">
                                ...
                                <div class="form-check mb-2">
                                    <input x-on:click="options.sim.all = ! options.sim.all" class="form-check-input" type="checkbox" id="openSimWindow" @if($lifting->mmst || $lifting->mmsts || $lifting->sim_swap || $lifting->sim_swap_ev) checked @endif>
                                    <label class="form-check-label text-white" for="openSimWindow">SIM</label>
                                </div>
                                <!-- MMST -->
                                <div class="form-check" style="margin-left: 20px">
                                    <input x-on:click="options.sim.mmst = ! options.sim.mmst" class="form-check-input" type="checkbox" id="openMmstWindow" @if($lifting->mmst) checked @endif>
                                ...
                                <!-- MMSTS -->
                                <div class="form-check" style="margin-left: 20px">
                                    <input x-on:click="options.sim.mmsts = ! options.sim.mmsts" class="form-check-input" type="checkbox" id="openMmstsWindow" @if($lifting->mmsts) checked @endif>
                                ...
                                <!-- Sim Swap -->
                                <div class="form-check" style="margin-left: 20px">
                                    <input x-on:click="options.sim.simSwap = ! options.sim.simSwap" class="form-check-input" type="checkbox" id="openSimSwapWindow" @if($lifting->sim_swap) checked @endif>
                                ...
                                <!-- Sim Swap Ev -->
                                <div class="form-check" style="margin-left: 20px">
                                    <input x-on:click="options.sim.simSwapEv = ! options.sim.simSwapEv" class="form-check-input" type="checkbox" id="openSimSwapEvWindow" @if($lifting->sim_swap_ev) checked @endif>
                            ...
                            <div class="col-sm-3 mb-3">
                                <!-- Container -->
                                <div class="form-check mb-2">
                                    <input x-on:click="options.sc.all = ! options.sc.all" class="form-check-input" type="checkbox" id="openScWindow" @if($lifting->sc_10 || $lifting->sc_14 || $lifting->scd_14 || $lifting->sc_19 || $lifting->scd_19 || $lifting->sc_20 || $lifting->scd_29) checked @endif>
                                    <label class="form-check-label text-white" for="openScWindow">Scratch Card</label>
                                </div>
                                <!-- SC-10 -->
                                <div class="form-check" style="margin-left: 20px">
                                    <input x-on:click="options.sc.sc10 = ! options.sc.sc10" class="form-check-input" type="checkbox" id="openSc10Window" @if($lifting->sc_10) checked @endif>
                                ...
                                <!-- SC-14 -->
                                <div class="form-check" style="margin-left: 20px">
                                    <input x-on:click="options.sc.sc14 = ! options.sc.sc14" class="form-check-input" type="checkbox" id="openSc14Window" @if($lifting->sc_14) checked @endif>
                                ...
                                <!-- SCD-14 -->
                                <div class="form-check" style="margin-left: 20px">
                                    <input x-on:click="options.sc.scd14 = ! options.sc.scd14" class="form-check-input" type="checkbox" id="openScd14Window" @if($lifting->scd_14) checked @endif>
                                ...
                                <!-- SC-19 -->
                                <div class="form-check" style="margin-left: 20px">
                                    <input x-on:click="options.sc.sc19 = ! options.sc.sc19" class="form-check-input" type="checkbox" id="openSc19Window" @if($lifting->sc_19) checked @endif>
                                ...
                                <!-- SCD-19 -->
                                <div class="form-check" style="margin-left: 20px">
                                    <input x-on:click="options.sc.scd19 = ! options.sc.scd19" class="form-check-input" type="checkbox" id="openScd19Window" @if($lifting->scd_19) checked @endif>
                                ...
                                <!-- SC-20 -->
                                <div class="form-check" style="margin-left: 20px">
                                    <input x-on:click="options.sc.sc20 = ! options.sc.sc20" class="form-check-input" type="checkbox" id="openSc20Window" @if($lifting->sc_20) checked @endif>
                                ...
                                <!-- SCD-29 -->
                                <div class="form-check" style="margin-left: 20px">
                                    <input x-on:click="options.sc.scd29 = ! options.sc.scd29" class="form-check-input" type="checkbox" id="openScd29Window" @if($lifting->scd_29) checked @endif>
                            ...
                            <div class="col-sm-3 mb-3">
                                <!-- Container -->
                                <div class="form-check mb-2">
                                    <input x-on:click="options.device.all = ! options.device.all" class="form-check-input" type="checkbox" id="openDeviceWindow" @if($lifting->router) checked @endif>
                                    <label class="form-check-label text-white" for="openDeviceWindow">Device</label>
                                </div>
                                <!-- Router -->
                                <div class="form-check" style="margin-left: 20px">
                                    <input x-on:click="options.device.router = ! options.device.router" class="form-check-input" type="checkbox" id="openRouterWindow" @if($lifting->router) checked @endif>
                            ...
                            <div class="col-sm-3 mb-3">
                                <!-- Container -->
                                <div class="form-check mb-2">
                                    <input x-on:click="options.bankDeposit = ! options.bankDeposit" class="form-check-input" type="checkbox" id="openBankDepositWindow" @if($lifting->itopup) checked @endif>
                ...
                <div x-transition x-cloak x-show="options.sim.all" class="card mb-3 bg-secondary bg-gradient">
                                ...
                                <div class="card mb-3 bg-gradient bg-secondary">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-9">
                                                <input x-model.number="productSim.mmst.qty" name="mmst" id="mmst" type="number" class="form-control" placeholder="Enter Quantity">
                                                ...
                                                <input :value="parseFloat(productSim.mmst.liftingPrice * productSim.mmst.qty).toFixed(2)" type="hidden" name="mmst_amount" id="mmst_amount" placeholder="mmst_amount">
                                    ...
                                    <div x-transition x-cloak x-show="productSim.mmst.qty" class="card-footer text-light">
                                        ...
                                        <p x-text="'Total Amount: ' + parseFloat(productSim.mmst.liftingPrice * productSim.mmst.qty).toFixed(2)"></p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div x-transition x-cloak x-show="options.sim.mmsts" class="col-lg-6">
                                <div class="card mb-3 bg-gradient bg-secondary">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                <input :value="parseFloat(productSim.mmsts.liftingPrice * productSim.mmsts.qty).toFixed(2)" type="hidden" name="mmsts_amount" id="mmsts_amount">
                                    ...
                                    <div x-transition x-cloak x-show="productSim.mmsts.qty" class="card-footer text-light">
                                        ...
                                        <p x-text="'Total Amount: ' + parseFloat(productSim.mmsts.liftingPrice * productSim.mmsts.qty).toFixed(2)"></p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div x-transition x-cloak x-show="options.sim.simSwap" class="col-lg-6">
                                <div class="card mb-3 bg-gradient bg-secondary">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                <input :value="parseFloat(productSim.simSwap.liftingPrice * productSim.simSwap.qty).toFixed(2)" type="hidden" name="sim_swap_amount" id="sim_swap_amount">
                                    ...
                                    <div x-transition x-cloak x-show="productSim.simSwap.qty" class="card-footer text-light">
                                        ...
                                        <p x-text="'Total Amount: ' + parseFloat(productSim.simSwap.liftingPrice * productSim.simSwap.qty).toFixed(2)"></p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div x-transition x-cloak x-show="totalSimAmount" class="card-footer">
                        <h4 x-text="'Total SIM Amount: ' + parseFloat(totalSimAmount).toFixed(2)" class="text-white"></h4>
                        <input :value="parseFloat(totalSimAmount).toFixed(2)" type="hidden" name="total_sim_amount" placeholder="total_sim_amount">
                    </div>
                </div>
                ...
                <div x-transition x-cloak x-show="options.sc.all" class="card mb-3 bg-secondary bg-gradient">
                            ...
                            <div x-transition x-cloak x-show="options.sc.sc10" class="col-lg-6">
                                <div class="card mb-3 bg-gradient bg-secondary">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                <input :value="parseFloat(productSc.sc10.price * productSc.sc10.qty).toFixed(2)" type="hidden" name="sc_10_amount">
                                                <input :value="parseFloat(productSc.sc10.liftingPrice * productSc.sc10.qty).toFixed(2)" type="hidden" name="sc_10_lifting_amount">
                                    ...
                                    <div x-transition x-cloak x-show="productSc.sc10.qty" class="card-footer text-light">
                                        ...
                                        <p x-text="'Amount: ' + parseFloat(productSc.sc10.price * productSc.sc10.qty).toFixed(2)"></p>
                                        <p x-text="'Lifting Amount: ' + parseFloat(productSc.sc10.liftingPrice * productSc.sc10.qty).toFixed(2)"></p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div x-transition x-cloak x-show="options.sc.sc14" class="col-lg-6">
                                <div class="card mb-3 bg-gradient bg-secondary">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                <input :value="parseFloat(productSc.sc14.price * productSc.sc14.qty).toFixed(2)" type="hidden" name="sc_14_amount" id="sc_14_amount">
                                    ...
                                    <div x-transition x-cloak x-show="productSc.sc14.qty" class="card-footer text-light">
                                        ...
                                        <p x-text="'Amount: ' + parseFloat(productSc.sc14.price * productSc.sc14.qty).toFixed(2)"></p>
                            ...
                            <div x-transition x-cloak x-show="options.sc.scd14" class="col-lg-6">
                                <div class="card mb-3 bg-gradient bg-secondary">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                <input :value="parseFloat(productSc.scd14.price * productSc.scd14.qty).toFixed(2)" type="hidden" name="scd_14_amount" id="scd_14_amount">
                                    ...
                                    <div x-transition x-cloak x-show="productSc.scd14.qty" class="card-footer text-light">
                                        ...
                                        <p x-text="'Amount: ' + parseFloat(productSc.scd14.price * productSc.scd14.qty).toFixed(2)"></p>
                            ...
                            <div x-transition x-cloak x-show="options.sc.sc19" class="col-lg-6">
                                <div class="card mb-3 bg-gradient bg-secondary">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                <input :value="parseFloat(productSc.sc19.price * productSc.sc19.qty).toFixed(2)" type="hidden" name="sc_19_amount" id="sc_19_amount">
                                    ...
                                    <div x-transition x-cloak x-show="productSc.sc19.qty" class="card-footer text-light">
                                        ...
                                        <p x-text="'Amount: ' + parseFloat(productSc.sc19.price * productSc.sc19.qty).toFixed(2)"></p>
                            ...
                            <div x-transition x-cloak x-show="options.sc.scd19" class="col-lg-6">
                                <div class="card mb-3 bg-gradient bg-secondary">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                <input :value="parseFloat(productSc.scd19.price * productSc.scd19.qty).toFixed(2)" type="hidden" name="scd_19_amount">
                                    ...
                                    <div x-transition x-cloak x-show="productSc.scd19.qty" class="card-footer text-light">
                                        ...
                                        <p x-text="'Amount: ' + parseFloat(productSc.scd19.price * productSc.scd19.qty).toFixed(2)"></p>
                            ...
                            <div x-transition x-cloak x-show="options.sc.sc20" class="col-lg-6">
                                <div class="card mb-3 bg-gradient bg-secondary">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                <input :value="parseFloat(productSc.sc20.price * productSc.sc20.qty).toFixed(2)" type="hidden" name="sc_20_amount">
                                    ...
                                    <div x-transition x-cloak x-show="productSc.sc20.qty" class="card-footer text-light">
                                        ...
                                        <p x-text="'Amount: ' + parseFloat(productSc.sc20.price * productSc.sc20.qty).toFixed(2)"></p>
                            ...
                            <div x-transition x-cloak x-show="options.sc.scd29" class="col-lg-6">
                                <div class="card mb-3 bg-gradient bg-secondary">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                <input :value="parseFloat(productSc.scd29.price * productSc.scd29.qty).toFixed(2)" type="hidden" name="scd_29_amount">
                                    ...
                                    <div x-transition x-cloak x-show="productSc.scd29.qty" class="card-footer text-light">
                                        ...
                                        <p x-text="'Amount: ' + parseFloat(productSc.scd29.price * productSc.scd29.qty).toFixed(2)"></p>
                    ...
                    <div x-transition x-cloak x-show="totalScAmount.amount" class="card-footer">
                        ...
                        <input :value="parseFloat(totalScAmount.amount).toFixed(2)" type="hidden" name="total_sc_amount">
                        <input :value="parseFloat(totalScAmount.liftingAmount).toFixed(2)" type="hidden" name="total_sc_lifting_amount">
                    </div>
                </div>
                ...
                <div x-transition x-cloak x-show="options.device.all" class="card mb-3 bg-secondary bg-gradient">
                            ...
                            <div x-transition x-cloak x-show="options.device.router" class="col-lg-6">
                                <div class="card mb-3 bg-gradient bg-secondary">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                <input :value="parseFloat(device.router.price * device.router.qty).toFixed(2)" type="hidden" name="router_amount">
                                    ...
                                    <div x-transition x-cloak x-show="device.router.qty" class="card-footer text-light">
                                        ...
                                        <p x-text="'Amount: ' + parseFloat(device.router.qty * device.router.price).toFixed(2)"></p>
                    ...
                    <div x-transition x-cloak x-show="totalDeviceAmount.amount" class="card-footer">
                        <h4 x-text="'Total Device Amount: ' + parseFloat(totalDeviceAmount.amount).toFixed(2)" id="totalDeviceAmount" class="text-white"></h4>
                        ...
                        <input :value="parseFloat(totalDeviceAmount.amount).toFixed(2)" type="hidden" name="total_device_amount" id="total_device_amount">
                ...
                <div class="d-flex align-items-center justify-content-between">
                    <button type="submit" class="btn btn-sm btn-primary me-2 btn-submit">Update Lifting</button>
        ...
        <script>
            document.addEventListener('alpine:init', () => {
                Alpine.data('liftingCreate', () => ({
                    options: {
                        sim: {
                            all: {{ empty($lifting->mmst || $lifting->mmsts || $lifting->sim_swap || $lifting->sim_swap_ev) ? 0 : 1 }},
                            mmst: {{ empty($lifting->mmst) ? 0 : 1 }},
                            mmsts: {{ empty($lifting->mmsts) ? 0 : 1 }},
                            simSwap: {{ empty($lifting->sim_swap) ? 0 : 1 }},
                            simSwapEv: {{ empty($lifting->sim_swap_ev) ? 0 : 1 }},
                        },
                        sc: {
                            all: {{ empty($lifting->sc_10 || $lifting->sc_14 || $lifting->scd_14 || $lifting->sc_19 || $lifting->scd_19 || $lifting->sc_20 || $lifting->scd_29) ? 0 : 1 }},
                            sc10: {{ empty($lifting->sc_10) ? 0 : 1 }},
                            sc14: {{ empty($lifting->sc_14) ? 0 : 1 }},
                            scd14: {{ empty($lifting->scd_14) ? 0 : 1 }},
                            sc19: {{ empty($lifting->sc_19) ? 0 : 1 }},
                            scd19: {{ empty($lifting->scd_19) ? 0 : 1 }},
                            sc20: {{ empty($lifting->sc_20) ? 0 : 1 }},
                            scd29: {{ empty($lifting->scd_29) ? 0 : 1 }},
                        },
                        device: {
                            all: {{ empty($lifting->router) ? 0 : 1 }},
                            router: {{ empty($lifting->router) ? 0 : 1 }},
                        },
                        bankDeposit: {{ empty($lifting->itopup) ? 0 : 1 }},
                    },
                    ...
                    bankDeposit: {{ $lifting->bank_deposit }},
